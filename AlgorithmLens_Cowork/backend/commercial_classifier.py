...
# KNOWN FALSE POSITIVE: "thanks to" pattern can appear in gratitude messages unrelated to sponsorship
# Example: "thanks to my followers for..." This is a known limitation but acceptable given high specificity elsewhere
HIGH_CONFIDENCE_PARTNERSHIP = [
    ...
    r"thanks\s+to\b",                  # "thanks to [brand]" - KNOWN FALSE POSITIVE RISK
