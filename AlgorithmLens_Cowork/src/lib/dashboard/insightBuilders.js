...
export function buildOverviewHero({ sourceConcentration, totalPosts, platformCount }) {
  ...
  if (top5 >= 60) {
    return {
      ...
      whyCare: 'This is above the typical range of 40–60%. A small number of creators make up a large portion of what appears in your feed.',
      meta,
    };
  } else if (top5 >= 40) {
    return {
...
export function buildSourcesHero({ top5Percent, totalPosts, platformCount, hasData }) {
  ...
  if (top5Percent >= 75) {
    ...
    return {
      ...
      whyCare: 'This is at the high end of typical (40–60%). These sources appear frequently in your feed.',
      meta,
    };
