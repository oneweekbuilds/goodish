...
function calculateCreatorConcentration(creatorsData) {
  if (!creatorsData || !creatorsData.creators || Object.keys(creatorsData.creators).length === 0) {
    return null;
  }
  ...
  // Get top 5 creators — creators is an Object (keyed by ID), so convert to sorted Array first
  const top5 = Object.values(creatorsData.creators)
...
export function compareTwoScans(baselineScan, compareScan, scanDetails) {
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating total posts:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating ad percentage:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating political content:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating unique creators:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating creator concentration:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating source origin:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating topic diversity:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating positive tone:', err);
  }
  ...
  try {
    ...
    logWarning('trendsComparison', 'Error calculating negative tone:', err);
  }
