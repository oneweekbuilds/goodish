    ...
    return (
        <section className="py-12 sm:py-24 bg-bg-page overflow-hidden">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center mb-10 sm:mb-14">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-text-main mb-4 sm:mb-6">Based on your feed, here's what the algorithm likely thinks about you.</h2>
