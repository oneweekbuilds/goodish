          ...
          <form onSubmit={handleSendMagicLink} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-border-light rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent disabled:bg-primary-blue/5 disabled:text-text-muted"
                autoFocus
              />
            </div>

            {error && (
              <div id="email-error" className="text-sm text-status-error bg-status-error/5 border border-status-error/20 rounded-lg p-3">
                {error}
              </div>
            )}
        ...
        {sent && (
          <div className="text-center space-y-4">
            <div className="bg-status-success/5 border border-status-success/20 rounded-lg p-4">
              <p className="text-status-success font-medium mb-1">Check your email</p>
