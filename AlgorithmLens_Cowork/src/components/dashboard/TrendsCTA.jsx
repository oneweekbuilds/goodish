 ...
 * For Plus users: Returns null (trends shown inline instead)
...
const TrendsCTA = ({ onClick, isPlusUser, tabName, scanCount }) => {
  // For Plus users, don't render CTA at all - trends shown inline
  if (isPlusUser) {
    return null;
  }
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          focusVisibleRingColor: 'rgba(37, 99, 235, 0.6)',
        }}
        onMouseEnter={(e) => {
