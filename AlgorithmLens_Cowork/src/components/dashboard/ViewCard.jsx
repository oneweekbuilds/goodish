...
const ViewCard = ({
  ...
  const renderMicroBar = ({ value = 0, color = '#0EA5E9' }) => {
    ...
    return (
      <div className="w-[88px] h-[12px] rounded-full bg-primary-blue/5 overflow-hidden border border-border-light">
        <div
  ...
  const renderMicroSegments = ({ segments = [] }) => {
    ...
    return (
      <div className="w-[96px] h-[14px] rounded-full bg-primary-blue/5 overflow-hidden border border-border-light flex">
