      ...
      <section>
        ...
        {politicalShare.hasData ? (
          <div className="bg-white border border-slate-200 rounded-lg p-6 space-y-3">
            ...
            <p className="text-sm text-slate-600">of your feed contained political keywords</p>
          ...
          <div className="rounded-xl p-6 text-center" style={{ background: "#FAFBFE", border: "1px solid rgba(37, 99, 235, 0.06)" }}>
            <p className="text-sm text-slate-500">
              Political exposure was light in this window. Scan more content to see a full breakdown.
            </p>
          </div>
        )}
      </section>
      ...
      {!isPlusUser && (
        <>
          <EvidenceBundleTeaser
            tabName="politics"
            teaserText="Plus breaks down the political content in your feed, including topic categories and how they compare across scans."
          />
          <FreeAskTeaser
            tabName="politics"
            exampleQuestion="How much of my feed contains political content compared to other categories?"
          />
        </>
      )}
