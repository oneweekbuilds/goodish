...
const ScanHistoryPage = () => {
    ...
    const fetchScans = async () => {
        ...
        try {
            ...
            logError("ScanHistoryPage", "Error fetching scans:", err);
    ...
    const fetchScanDetails = async (scanId) => {
        ...
        try {
            ...
            logError("ScanHistoryPage", "Error fetching scan details:", err);
    ...
    const deleteScan = async (scanId, e) => {
        ...
        try {
            ...
            logError("ScanHistoryPage", "Error deleting scan:", err);
