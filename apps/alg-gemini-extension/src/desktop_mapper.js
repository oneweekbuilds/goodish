...
function classifyTopic(keywords, hashtags) {
  console.log('[AlgorithmLens][Topic] classifyTopic called with:', { keywordsCount: keywords.length, hashtagsCount: hashtags.length, keywordsSample: keywords.slice(0, 10) });
  ...
  if (combined.length > 0) {
    console.log('[AlgorithmLens][Topic] Keywords extracted:', combined.slice(0, 20), '...(total:', combined.length, ')');
  }
  ...
  if (matchedKeywords.length > 0) {
    console.log('[AlgorithmLens][Topic] Matched keywords:', JSON.stringify(matchedKeywords));
  } else {
    console.log('[AlgorithmLens][Topic] No keywords matched from:', combined.slice(0, 30));
  }
  ...
  console.log('[AlgorithmLens][Topic] => Final topic:', finalTopic, '| Counts:', JSON.stringify(topicCounts));
  return finalTopic;
}
