      ...
      <div className="relative bg-white rounded-xl shadow-lg max-w-md w-full p-6 z-10">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-transparent text-text-main"
            autoFocus
          />
          {error && (
        ...
        <div className="flex gap-3">
          <button
            onClick={handleSkip}
            className="flex-1 px-4 py-2.5 text-text-muted font-medium rounded-lg hover:bg-slate-50 transition-colors"
          >
            Skip for now
          </button>
          <button
            onClick={handleSave}
            className="flex-1 px-4 py-2.5 bg-primary-blue text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors"
          >
            Save and continue
          </button>
        </div>
