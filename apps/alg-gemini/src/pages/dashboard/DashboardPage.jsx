...
const TAB_STORY_HEADERS = {
  algorithm: {
    ...
    summary: {
      ...
      subtext: 'Themes that appeared consistently during this window.',
    },
  },
  ads: {
    keyInsight: {
...
const ViewsGridWithCollapsing = ({ views, viewDataResults, scanCount, platformCount, tabName, tabId, heroViewId, scopeLabel }) => {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* R2 P0 FIX: "Try this" section removed - trust regression */}
    </div>
  );
};
...
const DashboardPage = () => {
  ...
  const deriveWindowLabel = (start, end, scansUsed) => {
    ...
    // R2 P0 FIX: Use window-based framing per Round 1 freeze
